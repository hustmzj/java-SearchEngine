...
public class Index extends AbstractIndex implements FileSerializable {
    ...
    public void addDocument(AbstractDocument document) {
        this.docIdToDocPathMapping.put(document.getDocId(), document.getDocPath());  //更新docIdToDocPathMap
        Map<AbstractTerm, Posting> map = new TreeMap<>();
        for (AbstractTermTuple tuple : document.getTuples()) {         //获取该文档的TermToPostingMap
        ...
        map.forEach((key, val) -> {                   //将该文档的TermToPostingMap汇入总的termToPostingListMap
